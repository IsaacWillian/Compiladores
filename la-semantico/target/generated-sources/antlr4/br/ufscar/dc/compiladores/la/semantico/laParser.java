...
public class laParser extends Parser {
	...
	public static final int
		...
		IDENT=60, NUM_INT=61, NUM_REAL=62, CADEIA=63, COMENTARIO=64, WS=65, ERRO_COMENTARIO=66, 
		ERRO_CADEIA=67, ERRO=68;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			"IDENT", "NUM_INT", "NUM_REAL", "CADEIA", "COMENTARIO", "WS", "ERRO_COMENTARIO", 
			"ERRO_CADEIA", "ERRO"
		};
	}
	...
	public final IdentificadorContext identificador() throws RecognitionException {
		...
		try {
			...
			while (_la==T__8) {
				...
				match(T__8);
				setState(144);
				((IdentificadorContext)_localctx).idents = match(IDENT);
				}
				}
				setState(149);
				_errHandler.sync(this);
	...
	public static class CmdSeContext extends ParserRuleContext {
		...
		public List<CmdContext> en = new ArrayList<CmdContext>();
		public List<CmdContext> sen = new ArrayList<CmdContext>();
	...
	public final CmdSeContext cmdSe() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__15) | (1L << T__27) | (1L << T__28) | (1L << T__29) | (1L << T__33) | (1L << T__36) | (1L << T__39) | (1L << T__41) | (1L << T__43) | (1L << IDENT))) != 0)) {
				...
				((CmdSeContext)_localctx).en.add(((CmdSeContext)_localctx).cmd);
				}
				}
				setState(316);
				_errHandler.sync(this);
			...
			if (_la==T__31) {
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__15) | (1L << T__27) | (1L << T__28) | (1L << T__29) | (1L << T__33) | (1L << T__36) | (1L << T__39) | (1L << T__41) | (1L << T__43) | (1L << IDENT))) != 0)) {
					...
					setState(318);
					((CmdSeContext)_localctx).cmd = cmd();
					((CmdSeContext)_localctx).sen.add(((CmdSeContext)_localctx).cmd);
					}
					}
					setState(323);
					_errHandler.sync(this);
	...
	public final CmdAtribuicaoContext cmdAtribuicao() throws RecognitionException {
		...
		try {
			...
			if (_la==T__15) {
				{
				setState(379);
				((CmdAtribuicaoContext)_localctx).pont = match(T__15);
				}
			}
	...
	public static class Parcela_unarioContext extends ParserRuleContext {
		public Token pont;
		public ExpressaoContext newexp;
		public IdentificadorContext identificador() {
			return getRuleContext(IdentificadorContext.class,0);
		}
		public TerminalNode IDENT() { return getToken(laParser.IDENT, 0); }
		...
		try {
			...
			case 1:
				...
				if (_la==T__15) {
					{
					setState(476);
					((Parcela_unarioContext)_localctx).pont = match(T__15);
					}
				}
			...
			case 5:
				...
				match(T__21);
				setState(495);
				((Parcela_unarioContext)_localctx).newexp = expressao();
				setState(496);
				match(T__22);
				}
				break;
	...
	public final Fator_logicoContext fator_logico() throws RecognitionException {
		...
		try {
			...
			if (_la==T__56) {
				{
				setState(531);
				((Fator_logicoContext)_localctx).not = match(T__56);
				}
			}
	...
	public final Parcela_logicaContext parcela_logica() throws RecognitionException {
		...
		try {
			...
			case T__17:
				...
				{
				setState(536);
				((Parcela_logicaContext)_localctx).logico = _input.LT(1);
				_la = _input.LA(1);
				if ( !(_la==T__16 || _la==T__17) ) {
					((Parcela_logicaContext)_localctx).logico = (Token)_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
					_errHandler.reportMatch(this);
	...
	public static final String _serializedATN =
		...
		"\3\2\16\21\4\2\23\24?A\3\2\60\61\3\2\62\63\4\2\b\b\66:\3\2\23\24\2\u0235"+
		...
		"\u01f6\u01f7\7\65\2\2\u01f7\u01fa\5\f\7\2\u01f8\u01fa\7A\2\2\u01f9\u01f6"+
